...
class VideoItemDetails extends Component {
  ...
  renderApiStatusViews = (isDark, addSavedVideo) => {
    ...
    switch (apiStatus) {
      ...
      case apiStatusConstants.success:
        return this.renderVideoField(isDark, addSavedVideo)
  ...
  render() {
    return (
      <ThemeContext.Consumer>
        {value => {
          const {isDark, addSSavedVideo} = value
          ...
          return (
            ...
            >
              ...
              <div className="app-container">
                <LeftNavbar />
                {this.renderApiStatusViews(isDark, addSSavedVideo)}
              </div>
            </div>
          )
        }}
